function goto(id) {
  ...
  currentScreen = id;
  const showBack = !['lander', 'waiting-host', 'waiting-join', 'game', 'vote-imp', 'vote-inn', 'results', 'gameover'].includes(id);
  ...
  if (exitEl) {
    const showExit = ['waiting-host', 'waiting-join', 'game', 'vote-imp', 'vote-inn', 'results', 'gameover'].includes(id);
